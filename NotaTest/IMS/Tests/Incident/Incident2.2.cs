...
namespace IMS.Tests.Incident2_2
{
    public class Incident2_2
    {
        ...
        [Test]
        public void TestIncident2_2()
        {
            test = extent.StartTest("Запуск БП Создание инцидента (муниципальный уровень)");
