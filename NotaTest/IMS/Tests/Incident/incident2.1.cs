...
namespace IMS.Tests.Incident2_1
{
    public class Incident2_1
    {
        ...
        [Test]
        public void TestIncident2_1()
        {
            test = extent.StartTest("Запуск БП Создание инцидента (региональный уровень)");
