...
namespace IMS.Tests.Incident1_8
{
    public class Incident1_8
    {
        ...
        [Test]
        public void TestIncident1_8()
        {
            test = extent.StartTest("Запуск БП Создание инцидента (федеральный уровень)");
